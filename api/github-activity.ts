 ...
 *
 * Server-side GitHub activity proxy for /api/github-activity. Also exports
 * getGitHubActivity for the Vite dev middleware. The shape mirrors
 * ProcessedActivity in src/lib/github.ts (kept in sync deliberately).
 */
