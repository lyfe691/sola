...
export const translations = {
  en: {
    ...
    randomizer: {
      ...
      description:
        "Spin the wheel to discover a theme. You can change it anytime in the top-right.",
      spin: "Spin",
      spinning: "Spinning...",
      keep: "Keep this",
    },
  ...
  de: {
    ...
    randomizer: {
      ...
      description:
        "Drehen Sie am Rad und entdecken Sie ein Design. Sie können es jederzeit oben rechts ändern.",
      spin: "Drehen",
      spinning: "Dreht...",
      keep: "Behalten",
    },
  ...
  es: {
    ...
    randomizer: {
      ...
      description:
        "Gira la rueda para descubrir un tema. Puedes cambiarlo cuando quieras arriba a la derecha.",
      spin: "Girar",
      spinning: "Girando...",
      keep: "Conservar",
    },
  ...
  ja: {
    ...
    randomizer: {
      ...
      description:
        "ホイールを回してテーマを見つけましょう。右上からいつでも変更できます。",
      spin: "回す",
      spinning: "回転中...",
      keep: "これにする",
    },
