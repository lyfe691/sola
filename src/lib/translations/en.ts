...
export const en = {
  ...
  common: {
    ...
    linkPrivate: "The live app is private.",
    linkPrivateClient:
      "Used inside the client's company, so the live app is private.",
    demo: "Demo",
  ...
  colophon: {
    ...
    faces:
      "The faces are [Geist](https://vercel.com/font) for both the reading and the names, [JetBrains Mono](https://fonts.google.com/specimen/JetBrains+Mono) for code, and [Shippori Mincho B1](https://fonts.google.com/specimen/Shippori+Mincho+B1) for ink like this. It lives on [Vercel](https://vercel.com); the source is on [GitHub](https://github.com/lyfe691/sola).",
