...
export const ko = {
  ...
  about: {
    title: "소개",
    intro:
      "저는 Yanis Sebastian Zürcher, 18살, 취리히에 사는 소프트웨어 개발자입니다. [WISS](https://www.wiss.ch)에서 컴퓨터 과학을 공부하지만, 아는 건 대부분 강의에만 앉아 있는 게 아니라 직접 프로젝트를 만들고 내보내면서 배웠습니다.",
    hobbies:
      "풀스택으로 일합니다. 백엔드, API, 데이터, 인터페이스까지 끝까지 다룹니다. 사람들이 실제로 쓰는 부분의 디테일을 중요하게 봅니다 — 성능, 명확함, 그리고 나중에 붙인 느낌이 아니라 제대로 짜인 UI. 스택은 위에 얹힌 것만이 아니라 제품 전체입니다.",
    philosophy: {
      title: "일하는 방식",
      clean:
