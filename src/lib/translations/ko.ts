...
export const ko = {
  ...
  about: {
    title: "소개",
    intro:
      "저는 스위스 취리히에 거주하는 18세 소프트웨어 개발자 Yanis Sebastian Zürcher입니다. 저는 [WISS](https://www.wiss.ch)에서 컴퓨터 과학을 공부하지만 제가 아는 대부분의 지식은 학교가 아닌 제 자신의 프로젝트를 구축하면서 얻은 것입니다.",
    hobbies:
      "저는 빠르고 깨끗하며 최소한의 웹 애플리케이션을 만드는 데 중점을 두고 있습니다. 풀스택 플랫폼이든 날카로운 프런트엔드든 저는 명확성, 성능, 세련된 사용자 경험에 관심을 갖습니다. 나는 항상 내 아이디어를 발전시켜 기능만큼 기분이 좋은 것을 만들고 있습니다.",
    philosophy: {
      title: "저의 접근 방식",
      clean:
        "저는 깨끗하고 유지 관리가 가능한 코드가 지속 가능한 소프트웨어 개발의 기초라고 믿습니다. 내가 쓰는 모든 줄은 우수성소개 나의 헌신을 반영합니다.",
      simplicity:
        "복잡한 문제에는 우아한 해결책이 필요합니다. 저는 기능, 성능, 사용자 경험 사이의 완벽한 균형을 찾기 위해 노력합니다.",
      learning:
        "기술 환경은 빠르게 발전하고 있으며 나도 마찬가지입니다. 지속적인 학습과 적응은 내 직업 정체성의 필수 구성 요소입니다.",
    },
    interests: {
      title: "관심사와 열정",
      nature: {
        title: "알프스 탐방",
        description:
          "스위스에서의 생활은 자연소개 놀라운 접근성을 제공합니다. 나는 정기적으로 알프스를 하이킹하면서 도전과 자연의 아름다움이 조화를 이루어 기술적 작업에 정신적 명료함과 창의적인 영감을 모두 제공한다는 사실을 깨달았습니다.",
      },
      tech: {
        title: "오픈소스 기여",
        description:
          "저는 특히 성능 최적화 및 접근성 개선에 중점을 두고 여러 오픈 소스 프로젝트에 적극적으로 기여하고 있습니다. 이러한 커뮤니티 참여를 통해 저는 제가 소중히 여기는 생태계에 환원하는 동시에 최첨단 기술을 유지할 수 있습니다.",
      },
      learning: {
        title: "기술 문헌",
        description:
          "나는 엄선된 기술 서적 컬렉션을 유지하고 정기적으로 온라인 강좌에 참여합니다. 현재 내 프로젝트에 적용하는 분산 시스템 및 기능적 프로그래밍 패러다임의 고급 패턴을 탐색하고 있습니다.",
      },
      workspace: {
        title: "최적화된 환경",
        description:
          "내 작업 공간은 생산성과 창의성을 극대화하도록 세심하게 설계되었습니다. 저는 길고 집중적인 개발 세션을 가능하게 하는 맞춤형 기계식 키보드와 인체공학적 솔루션을 갖춘 미니멀리스트 듀얼 모니터 설정을 사용합니다.",
      },
    },
    testimonials: {
      title: "사람들이 말하는 것",
