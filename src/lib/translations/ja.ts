...
export const ja = {
  ...
  about: {
    title: "私について",
    intro:
      "ヤニス・セバスチャン・ズルヒャー（Yanis Sebastian Zürcher）。18歳、チューリッヒ在住のソフトウェア開発者です。[WISS](https://www.wiss.ch)でコンピュータサイエンスを学んでいますが、知識のほとんどは講義に座っているだけでなく、自分のプロジェクトを作り、公開するなかで身につけました。",
    hobbies:
      "フルスタックで仕事をしています。バックエンド、API、データ、そしてインターフェースまで、通しで作ります。人が実際に触る部分の細部には特にこだわっています。パフォーマンス、分かりやすさ、あとから貼りつけた感じではないUI。スタックは上に乗っているものだけでなく、プロダクト全体です。",
    philosophy: {
      title: "働き方",
      clean:
