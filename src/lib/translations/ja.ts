...
export const ja = {
  ...
  about: {
    title: "私について",
    intro:
      "ヤニス・セバスチャン・ズルヒャー（Yanis Sebastian Zürcher）。18歳、チューリッヒ在住。[WISS](https://www.wiss.ch)でコンピュータサイエンスを学んでいますが、知識のほとんどは講義ではなく、自分のプロジェクトを出すなかで身につけました。",
    hobbies:
      "邪魔をしないWebアプリを作ります。速く、ミニマルで、触り心地に少しこだわる。必要なときはフルスタック、UIが本体のときはフロントエンド。",
    philosophy: {
      title: "働き方",
      clean:
    ...
    interests: {
      ...
      nature: {
        title: "山",
        description:
          "スイスだと簡単です。長いハイキングのほうが、コーヒーもう一杯より頭の中の未完了リストを片づけます。",
      },
      tech: {
        title: "オープンソース",
        description:
          "できるところで手を出します。主にパフォーマンスとアクセシビリティ。より良いコードに怒られる良い方法です。",
      },
      learning: {
        title: "読書",
        description:
          "余裕があるときは技術書、ないときは深い記事やコース。最近はシステムとWebプラットフォームの変な端っこ。",
      },
      workspace: {
        title: "机",
        description:
          "モニタ二枚、うるさいキーボード、それ以外はあまり置かない。いじれるものが少ないほど、長く作業にいられます。",
      },
    },
    testimonials: {
      title: "一緒に働いた人から",
