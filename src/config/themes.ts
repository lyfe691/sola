...
import { MoonStar, Sun, Cloud, Sprout, Slack, Trees, Coffee, LaptopMinimal } from "lucide-react";
...
export const THEMES: ThemeConfig[] = [
  ...
  { value: "system", label: "System", icon: LaptopMinimal, isCustom: false, type: "light" }, // system handled via getThemeType
  ...
  { value: "rose", label: "Rose", icon: RoseIcon as unknown as ElementType, isCustom: true, type: "light" },
];
