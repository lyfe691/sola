...
It works well with static websites, but it's not recommended for dynamic websites that rely on a heavy backend or frameworks like Next.js or React.

<ProjectGallery
  images={[
    {
      src: "/projects/code-extractor/code-extractor.png",
      alt: "Chrome extension development",
      caption: "Usage of the extension",
    },
    {
      src: "/projects/code-extractor/code-extractor-zoom.png",
      alt: "Chrome extension development",
      caption: "Zoomed in view of the Chrome extension",
    },
  ]}
  columns={2}
/>
...
_The Website Code Extractor proves that simple tools solving real problems can have significant impact in the developer community._
