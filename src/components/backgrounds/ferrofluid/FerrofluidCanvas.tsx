/**
 * Ferrofluid — animated ferrofluid-like metaballs (OGL/WebGL).
 * Source: React Bits (reactbits.dev/backgrounds/ferrofluid), prop-driven.
 * Theme-awareness lives in the sibling `Ferrofluid.tsx` wrapper.
 */

import { useEffect, useRef, type CSSProperties } from "react";
import { Renderer, Program, Mesh, Triangle } from "ogl";

export interface FerrofluidCanvasProps {
  className?: string;
  dpr?: number;
  paused?: boolean;
  colors?: string[];
