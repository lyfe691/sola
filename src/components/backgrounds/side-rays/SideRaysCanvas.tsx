/**
 * SideRays — animated light rays (OGL/WebGL).
 * Source: React Bits (reactbits.dev/backgrounds/side-rays), prop-driven.
 * Theme-awareness lives in the sibling `SideRays.tsx` wrapper.
 */
...
export default function SideRaysCanvas({
  speed = 2.5,
  rayColor1 = "#EAB308",
  rayColor2 = "#96c8ff",
  intensity = 2,
