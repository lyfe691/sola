/**
 * PixelBlast — animated pixelated noise / ripple field (three + postprocessing).
 * Source: React Bits (reactbits.dev/backgrounds/pixel-blast), prop-driven.
 * Theme-awareness lives in the sibling `PixelBlast.tsx` wrapper.
 */
...
export interface PixelBlastCanvasProps {
...
export default function PixelBlastCanvas({
  variant = "square",
  pixelSize = 3,
  color = "#B497CF",
  className,
