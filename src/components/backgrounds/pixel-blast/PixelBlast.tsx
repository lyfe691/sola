 ...
 *
 * Theme-aware PixelBlast — picks its preset from the active theme and reacts to
...
import PixelBlastCanvas from "./PixelBlastCanvas";
import { getPixelBlastPreset, PIXEL_BLAST_THEME_CLASS_KEYS } from "./presets";

const detectThemeFromHtml = (): Exclude<Theme, "system"> => {
  const cls = document.documentElement.classList;
  for (const key of PIXEL_BLAST_THEME_CLASS_KEYS)
...
export default function PixelBlast() {
  ...
  return <PixelBlastCanvas {...getPixelBlastPreset(theme)} />;
}
